...
const Button: React.FC<ButtonProps> = ({
  ...
  const handleClick = (elem: string) => {
    if (!disable && setGameState && setUser) {
      setGameState(gameStage![1]);
      setUser(elem);
  ...
  if (img === "paper") {
    return (
      <div className="box_game paper_box">
        <button
          className={
            activate ? "button_game paper activate" : "paper button_game"
          }
          type="button"
          onClick={() => {
            handleClick("paper");
  ...
  if (img === "rock") {
    return (
      <div className="box_game rock_box">
        <button
          className={
            activate ? "button_game rock activate" : "rock button_game"
          }
          type="button"
  ...
  if (img === "scissors") {
    return (
      <div className="box_game scissors_box">
        <button
          className={
            activate ? "button_game scissors activate" : "scissors button_game"
          }
          type="button"
